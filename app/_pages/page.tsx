        ...
        <section id="home" className="flex flex-col md:flex-row items-center justify-between min-h-screen py-12 md:py-20">
          <div className="w-full md:w-1/2 space-y-6 md:pr-8">
            ...
            <div className="pt-10 flex flex-col sm:flex-row gap-4 sm:space-x-6">
              ...
              <Link href="#contact" className="px-6 cursor-pointer sm:px-8 py-3 sm:py-4 bg-gray-800 hover:bg-gray-700 rounded-lg text-white font-medium transition-all duration-300 border border-gray-700 hover:border-gray-600">
                Get In Touch
              </Link>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 mt-12 md:mt-0 flex justify-center relative">
            ...
            <div className="relative group h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] w-full flex items-center justify-center">
              <Image
                src="/images/sumit1.png"
                alt="Sumit Walia"
                width={500}
                height={700}
                className="rounded-lg shadow-lg relative h-full w-auto object-contain md:object-cover lg:object-contain"
                priority
              />
