...
function VideoList() {
    ...
    return (
        <div className="mt-8">
            <h3 className="text-xl font-semibold text-white mb-4">Uploaded Videos</h3>
                    ...
                    >
                        <div className="aspect-video relative">
                            ...
                            <div className="absolute top-2 right-2">
                                <button
                                    onClick={() => handleDelete(video._id, video.public_id)}
...
export default function Video() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (!formData.title || !formData.videoUrl || !formData.public_id) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 bg-[#333333] border border-[#444444] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
